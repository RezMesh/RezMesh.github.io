...
"hero.tag":"Communication beyond infrastructure.","hero.sub":"Communicate without cellular service or internet infrastructure.","hero.body":"Rez-Mesh is designed for resilient device-to-device communication when conventional networks are unavailable, disrupted, overloaded, or out of reach.","hero.cta1":"Explore Rez-Mesh","hero.cta2":"See How It Works","hero.beta":"Beta release coming soon. For Beta access, contact Soheil Mozaffari directly.","hero.legendInfra":"Conventional infrastructure","hero.legendMesh":"Rez-Mesh local path","hero.seq":"SEQ 01 — Infrastructure loss / mesh formation",
...
"princ.l1":"The infrastructure can disappear.","princ.l2":"The people and their devices are still there.","princ.note":"Rez-Mesh turns the devices that remain into potential communication points.",
"prob.kick":"The problem","prob.head":"When the network is gone, nearby devices can still communicate.","prob.lead":"Infrastructure can disappear. The need to communicate does not.","prob.body":"Cellular towers, internet access, centralized services, and remote infrastructure are useful—until they are damaged, unavailable, congested, blocked, or simply too far away. Rez-Mesh approaches communication from the other direction: start with the devices that are still physically present.","prob.btnRemove":"Remove infrastructure","prob.btnRestore":"Restore infrastructure","prob.note":"Distance is extended through participating nearby nodes—not through magical long-range radio.",
...
"eng.kick":"Authorship & method","eng.head":"Engineering behind Rez-Mesh","eng.bound":"Rez-Mesh is developed using BOUND Method v3.0 — Boundary-Oriented Unified Development.","eng.author":"Rez-Mesh is developed by Soheil Mozaffari, a software engineer and the author of BOUND Method v3.0.","eng.l1":"Soheil Mozaffari — professional website","eng.l4":"BOUND Method website","eng.l5":"BOUND DOI record on Zenodo","eng.former":"FORMERLY",
"beta.kick":"Availability","beta.head":"Rez-Mesh Beta is coming soon.","beta.body":"Rez-Mesh is preparing for its Beta release. Organizations, researchers, journalists, potential partners, and interested Beta users can contact Soheil Mozaffari directly for information about Beta access.","beta.cta":"Contact for Beta Access","beta.mail":"Direct contact:","beta.copy":"Copy email",
"toast.copied":"Email copied",
"foot.tag":"Communication beyond infrastructure.","foot.product":"Product","foot.identity":"Identity","foot.langs":"Languages","foot.history":"Rez-Mesh was formerly known as RezvanMesh.","foot.colophon":"Diagrams are schematic and not to scale. Set in Space Grotesk, IBM Plex Sans & IBM Plex Mono.","foot.rights":"© Soheil Mozaffari. All rights reserved.",
"title":"Rez-Mesh — Communication beyond infrastructure"},
...
"hero.tag":"ارتباط فراتر از زیرساخت.","hero.sub":"بدون سرویس تلفن همراه یا زیرساخت اینترنت، ارتباط برقرار کنید.","hero.body":"Rez-Mesh برای ارتباط مقاوم دستگاه‌به‌دستگاه طراحی شده است؛ هنگامی که شبکه‌های متداول در دسترس نیستند، مختل شده‌اند، اشباع شده‌اند یا خارج از دسترس‌اند.","hero.cta1":"کاوش Rez-Mesh","hero.cta2":"نحوه عملکرد را ببینید","hero.beta":"انتشار نسخه بتا به‌زودی. برای دسترسی بتا، مستقیماً با سهیل مظفری تماس بگیرید.","hero.legendInfra":"زیرساخت متداول","hero.legendMesh":"مسیر محلی Rez-Mesh","hero.seq":"ترتیب ۰۱ — فقدان زیرساخت / شکل‌گیری مش",
...
"poc.kick":"بدون سخت‌افزار ویژه","poc.head":"پیرامون دستگاهی که همین حالا در جیب شماست","poc.lead":"شبکه از دستگاه‌هایی آغاز می‌شود که مردم همراه دارند.","poc.f1":"گوشی","poc.s1":"یک دستگاه اندروید معمولی، بدون سخت‌افزار افزوده","poc.f2":"ارتباط بی‌سیم محلی","poc.s2":"کشف BLE، حمل Wi‑Fi Direct","poc.f3":"دستگاه‌های نزدیک Rez-Mesh","poc.s3":"هر دستگاه مشارکت‌کننده یک گره است","poc.f4":"مسیرهای ارتباطی مقاوم محلی","poc.s4":"برد جهش‌به‌جهش گسترش می‌یابد، نه با جادو","poc.labA":"پایانه منزوی","poc.labB":"گره مشارکت‌کننده",
...
"eng.kick":"مالکیت و روش","eng.head":"مهندسی پشت Rez-Mesh","eng.bound":"Rez-Mesh با متد BOUND نسخه ۳.۰ توسعه یافته است — Boundary-Oriented Unified Development.","eng.author":"Rez-Mesh توسط سهیل مظفری، مهندس نرم‌افزار و نویسنده متد BOUND نسخه ۳.۰، توسعه داده می‌شود.","eng.l1":"وب‌گاه حرفه‌ای سهیل مظفری","eng.l4":"وب‌گاه متد BOUND","eng.l5":"رکورد DOI در Zenodo","eng.former":"پیشتر",
"beta.kick":"دسترس‌پذیری","beta.head":"نسخه بتای Rez-Mesh به‌زودی منتشر می‌شود.","beta.body":"Rez-Mesh برای انتشار بتا آماده می‌شود. سازمان‌ها، پژوهشگران، خبرنگاران، شرکای بالقوه و کاربران علاقه‌مند می‌توانند برای دسترسی بتا مستقیماً با سهیل مظفری تماس بگیرند.","beta.cta":"تماس برای دسترسی بتا","beta.mail":"تماس مستقیم:","beta.copy":"کپی رایانامه",
"toast.copied":"رایانامه کپی شد",
"foot.tag":"ارتباط فراتر از زیرساخت.","foot.product":"محصول","foot.identity":"هویت","foot.langs":"زبان‌ها","foot.history":"Rez-Mesh پیش‌تر با نام RezvanMesh شناخته می‌شد.","foot.colophon":"نمودارها شماتیک و بدون مقیاس‌اند. تنظیم‌شده با Space Grotesk، IBM Plex Sans و IBM Plex Mono.","foot.rights":"© سهیل مظفری. تمامی حقوق محفوظ است.",
"title":"Rez-Mesh — ارتباط فراتر از زیرساخت"},
...
"hero.tag":"اتصال يتجاوز البنية التحتية.","hero.sub":"تواصل دون خدمة خلوية أو بنية تحتية للإنترنت.","hero.body":"صُمم Rez-Mesh لاتصال مرن من جهاز إلى جهاز عندما تكون الشبكات التقليدية غير متاحة أو معطلة أو مثقلة بالأحمال أو بعيدة المنال.","hero.cta1":"استكشف Rez-Mesh","hero.cta2":"شاهد كيف يعمل","hero.beta":"سيصدر الإصدار التجريبي قريبًا. للوصول التجريبي، تواصل مباشرة مع سهيل مظفري.","hero.legendInfra":"البنية التحتية التقليدية","hero.legendMesh":"مسار Rez-Mesh المحلي","hero.seq":"التسلسل 01 — فقدان البنية / تشكّل الشبكة",
...
"princ.l1":"قد تختفي البنية التحتية.","princ.l2":"الناس وأجهزتهم ما زالوا هناك.","princ.note":"يحوّل Rez-Mesh الأجهزة المتبقية إلى نقاط اتصال محتملة.",
"prob.kick":"المشكلة","prob.head":"حين تختفي الشبكة، تبقى الأجهزة القريبة قادرة على التواصل.","prob.lead":"قد تختفي البنية التحتية، لكن الحاجة إلى التواصل لا تختفي.","prob.body":"الأبراج الخلوية والإنترنت والخدمات المركزية مفيدة—حتى تتضرر أو تصبح غير متاحة أو مزدحمة أو محظورة أو بعيدة جدًا. يبدأ Rez-Mesh الاتصال من الاتجاه الآخر: من الأجهزة الموجودة فعليًا في المكان.","prob.btnRemove":"أزل البنية التحتية","prob.btnRestore":"أعد البنية التحتية","prob.note":"تمتد المسافة عبر الأجهزة القريبة المشاركة—لا عبر اتصال سحري بعيد المدى.",
...
"eng.kick":"التأليف والمنهج","eng.head":"الهندسة خلف Rez-Mesh","eng.bound":"يُطوَّر Rez-Mesh باستخدام منهجية BOUND الإصدار 3.0 — التطوير الموحّد الموجّه بالحدود.","eng.author":"يطوّر Rez-Mesh سهيل مظفري، مهندس برمجيات ومؤلف منهجية BOUND الإصدار 3.0.","eng.l1":"الموقع المهني لسهيل مظفري","eng.l4":"موقع منهجية BOUND","eng.l5":"سجل DOI على Zenodo","eng.former":"سابقًا",
"beta.kick":"التوفر","beta.head":"سيصدر Rez-Mesh التجريبي قريبًا.","beta.body":"يستعد Rez-Mesh لإصداره التجريبي. يمكن للمنظمات والباحثين والصحفيين والشركاء المحتملين والمستخدمين المهتمين مراسلة سهيل مظفري مباشرة للحصول على وصول تجريبي.","beta.cta":"تواصل للوصول التجريبي","beta.mail":"تواصل مباشر:","beta.copy":"نسخ البريد",
"toast.copied":"تم نسخ البريد",
"foot.tag":"اتصال يتجاوز البنية التحتية.","foot.product":"المنتج","foot.identity":"الهوية","foot.langs":"اللغات","foot.history":"كان Rez-Mesh معروفًا سابقًا باسم RezvanMesh.","foot.colophon":"المخططات توضيحية وليست بمقياس. التنسيق بخطوط Space Grotesk وIBM Plex Sans وIBM Plex Mono.","foot.rights":"© سهيل مظفري. جميع الحقوق محفوظة.",
"title":"Rez-Mesh — اتصال يتجاوز البنية التحتية"}};
const TITLES={en:"Rez-Mesh — Communication beyond infrastructure",fa:"Rez-Mesh — ارتباط فراتر از زیرساخت",ar:"Rez-Mesh — اتصال يتجاوز البنية التحتية"};
...
let MOTION_PAUSED=RM;
function announce(msg){const el=document.getElementById("a11yAnnouncer");if(!el||!msg)return;el.textContent="";requestAnimationFrame(()=>{el.textContent=msg;});}
...
function makeLoop(dur,steps,target,onTick){let idx=0,tt=0,last=0,run=false,raf=0;
  ...
  function start(){if(RM){steps.forEach(s=>s.fn());if(onTick)onTick(dur);return;}if(MOTION_PAUSED||run)return;run=true;last=0;raf=requestAnimationFrame(frame);}
...
document.addEventListener("visibilitychange",()=>{if(document.hidden)LOOPS.forEach(l=>l.pause());
  else if(!MOTION_PAUSED)LOOPS.forEach(l=>{if(!l.target)return;const r=l.target.getBoundingClientRect();if(r.bottom>0&&r.top<innerHeight)l.start();});});
/* ================= chrome ================= */
...
document.addEventListener("keydown",e=>{if(e.key==="Escape"&&menuBtn.getAttribute("aria-expanded")==="true")setMenu(false,true);});
...
if(story){
  ...
  storySteps.forEach((btn,i)=>btn.addEventListener("click",()=>{
    ...
    setStory(i,i===3);
    announce(btn.dataset.status||"");
    if(storyLoop&&!RM&&!MOTION_PAUSED)storyRestart=setTimeout(()=>storyLoop.start(),4500);
  }));
}
/* ================= HOW (scrub) ================= */
...
const howTall=$("#howTall"),HOWP=[.14,.34,.62,.96];
let howP=0,howTween=0,howRestart=0;
function howTo(target,dur=720){
  target=cl(target);
  cancelAnimationFrame(howTween);
  if(RM||MOTION_PAUSED){applyHow(target);howP=target;return;}
  const from=howP,start=performance.now();
  const step=now=>{
    const q=Math.min(1,(now-start)/dur),ease=1-Math.pow(1-q,3);
    howP=from+(target-from)*ease;
    applyHow(howP);
    if(q<1)howTween=requestAnimationFrame(step);
  };
  howTween=requestAnimationFrame(step);
}
const howLoop=makeLoop(14,[
  {t:0,fn:()=>howTo(HOWP[0])},
  {t:3.4,fn:()=>howTo(HOWP[1])},
  {t:6.8,fn:()=>howTo(HOWP[2])},
  {t:10.2,fn:()=>howTo(HOWP[3])}
],howTall);
howLis.forEach((li,i)=>{
  li.tabIndex=0;
  li.setAttribute("role","button");
  li.setAttribute("aria-label",li.querySelector("h3")?.innerText||"");
  const select=()=>{
    howLoop.pause();
    clearTimeout(howRestart);
    howTo(HOWP[i]);
    howRestart=setTimeout(()=>{if(!RM&&!MOTION_PAUSED)howLoop.start();},5000);
  };
  li.addEventListener("click",select);
  li.addEventListener("keydown",e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault();select();}});
});
if(RM)applyHow(1);else{howP=HOWP[0];applyHow(howP);}
/* ================= EMERGENCY ================= */
...
buildDuty();
function powFrame(ts){if(!powRun||MOTION_PAUSED){powRaf=0;return;}if(!powLast)powLast=ts;const dt=(ts-powLast)/1000;powLast=ts;
...
if(RM){setState("balanced");batt=62;$("#battFill").style.height="62%";$("#battPct").textContent="62%";
  ...
  setInterval(()=>{if(powRun&&!document.hidden&&!MOTION_PAUSED)scopeTick();},90);
...
/* ================= SCENARIOS ================= */
const SCN_N=7;let scnIdx=0,scnTimer=0,scnPaused=false,scnVisible=false;
...
function buildScnList(){list.innerHTML="";for(let i=0;i<SCN_N;i++){
  ...
  b.id="scenario-tab-"+i;b.setAttribute("aria-controls","scenario-panel-"+i);b.setAttribute("tabindex",i===scnIdx?"0":"-1");
  ...
  list.appendChild(b);}
  items.forEach((it,i)=>{it.id="scenario-panel-"+i;it.setAttribute("role","tabpanel");it.setAttribute("aria-labelledby","scenario-tab-"+i);});
}
function setScn(i){scnIdx=i;
  $("#scnList .srow2").forEach((r,k)=>{const on=k===i;r.classList.toggle("on",on);r.setAttribute("aria-selected",String(on));r.setAttribute("tabindex",on?"0":"-1");});
  items.forEach((it,k)=>{const on=k===i;it.classList.toggle("on",on);it.setAttribute("aria-hidden",String(!on));});
...
function resetScnTimer(){clearInterval(scnTimer);
  scnTimer=setInterval(()=>{if(!scnPaused&&scnVisible&&!document.hidden&&!MOTION_PAUSED)setScn((scnIdx+1)%SCN_N);},7000);}
...
list.addEventListener("keydown",e=>{
  ...
  const tabs=$("#scnList [role='tab']");let i=tabs.indexOf(tab),next=i;
  ...
  e.preventDefault();setScn(next);tabs[next].focus();resetScnTimer();
});
if("IntersectionObserver"in window)new IntersectionObserver(es=>es.forEach(e=>{scnVisible=e.isIntersecting;}),{threshold:.08}).observe($("#scenarios"));else scnVisible=true;
...
function syncMotionToggle(){
  ...
  motionToggle.setAttribute("aria-pressed",String(MOTION_PAUSED));
  const lab=motionToggle.querySelector(".motion-label");
  const icon=motionToggle.querySelector(".motion-icon");
  if(lab)lab.textContent=MOTION_PAUSED?motionToggle.dataset.resume:motionToggle.dataset.pause;
  if(icon)icon.textContent=MOTION_PAUSED?"▶":"Ⅱ";
}
function setMotionPaused(paused,userInitiated=false){
  MOTION_PAUSED=paused;
  document.documentElement.classList.toggle("motion-paused",paused);
  if(paused){
    LOOPS.forEach(l=>l.pause());
    if(powRaf){cancelAnimationFrame(powRaf);powRaf=0;}
  }else{
    LOOPS.forEach(l=>{if(!l.target)return;const r=l.target.getBoundingClientRect();if(r.bottom>0&&r.top<innerHeight)l.start();});
    if(powRun&&!powRaf){powLast=0;powRaf=requestAnimationFrame(powFrame);}
  }
  syncMotionToggle();
  if(userInitiated)announce(paused?motionToggle.dataset.paused:motionToggle.dataset.resumed);
}
if(motionToggle){
  if(RM)document.documentElement.classList.add("motion-paused");
  syncMotionToggle();
  motionToggle.addEventListener("click",()=>setMotionPaused(!MOTION_PAUSED,true));
}
